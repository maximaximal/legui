...
void
Hoverable::onUpdate(float frametime) {
  m_hoverGained = false;
  m_hoverLost = false;
}
bool
Hoverable::onEvent(const sf::Event& e) {
...
void
Hoverable::D_onHoverGained() {}
void
Hoverable::D_onHoverLost() {}
}
