...
namespace legui
{
    ...
    void Checkbox::setBoundingBox(const sf::FloatRect &box)
    {
        Checkable::setBoundingBox(box);
    }
    void Checkbox::D_checked()
    {
       
    }
    void Checkbox::D_unchecked()
    {
    
    }
    void Checkbox::onHoverGained()
    {
    
    }
    void Checkbox::onHoverLost()
    {
