...
namespace legui
{
     ...
     *
     * To use your own texture manager together with legui, register it in the config
     * and derive it from this class.
     */
    class TextureManagerAbstract
    {
        public:
             ...
             */
            virtual const sf::IntRect& getRect(const std::string &path, const std::string &rect, unsigned int number) = 0;
    };
}
