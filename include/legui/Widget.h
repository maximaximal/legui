...
class Widget : public sf::Drawable {
   ...
   *
   * @return Blocking-Flag (true if the event is catched and shouldn't be
   * processed further; false if else)
   */
   ...
   *
   * This is called when, for example, the content of a widget changes and a new
   * size of the parent has to be computed.
   *
